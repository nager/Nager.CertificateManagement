...
{
    public class ObjectStorageCertificateJobRepository : ICertificateJobRepository
    {
        private readonly IObjectStorage _objectStorage;
        private readonly string _prefix = "certificatejobs";

        public ObjectStorageCertificateJobRepository(IObjectStorage objectStorage)
        {
        ...
        public async Task<bool> AddAsync(AddCertificateJob addCertificateJob, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<bool> UpdateStatusAsync(Guid id, CertificateJobStatus certificateJobStatus, CancellationToken cancellationToken = default)
        {
            var certificateJob = await this.GetAsync(id, cancellationToken);
        ...
        public async Task<CertificateJob> GetAsync(Guid id, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<CertificateJob[]> GetAllAsync(CancellationToken cancellationToken = default)
        {
